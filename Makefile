...
toptb:
	$(CC) -o toptest test/top_tb.v topmodule_test.v ProgramCounter.v mem_prog.v mem_data.v ALUbasic.v FlagRegister.v dualPReg_tmt.v stackptr.v pipeControl_old.v
	$(RUN) toptest
